...
{   
    ...
    /// <summary>
    /// 주파수,위상에 대한 데이터 디스플레이를 도우는 클래스입니다.
    /// </summary>
    public partial class CFRAPlot
    {
        ...
        public CFRAPlot(ScottPlot.FormsPlot _formsPlot)
        {
        ...
        /// </summary>
        /// <param name="PrintConsole">콘솔 출력 Enable</param>
        /// <returns></returns>
        public string GetVersion(bool PrintConsole = false)
        {
            string version = "v2.0.0";
            string date = "22.02.28";
        ...
        private class FRAHandler
        {
            ...
            /// <returns></returns>
            public Result Input(double fre, double mag, double pha)
            {
