...
namespace ControlFlots.fXY
{
    ...
    public partial class CXYPlot
    {
        ...
        public CXYPlot(ScottPlot.FormsPlot formsPlot)
        {
            this.formsPlot = formsPlot;
            formsPlot.Reset();

            Up = new XYHandler(formsPlot, UpDown.Up);
            Down = new XYHandler(formsPlot, UpDown.Down);
        ...
        private class XYHandler
        {
            ...
            UpDown me;
            public XYHandler(ScottPlot.FormsPlot formsPlot, UpDown upDown)
            {
                this.formsPlot = formsPlot;
                me = upDown;
                ...
                for(int i=0;i<6;i++)
                {
                    ...
                    yAxis[i] = formsPlot.Plot.AddAxis(ScottPlot.Renderable.Edge.Left, i + 2 + 6 * (int)upDown);
                    ...
                    ScatterHandler[i].YAxisIndex = i + 2 + 6 * (int)upDown;
