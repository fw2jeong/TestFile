...
namespace ControlFlots.fFRA
{
    ...
    {
        /// <summary>
        /// 차트의 추가적인 기능을 모아놓은 클래스 입니다.
        /// </summary>
        public partial class CTool
        {
            CFRAPlot FRAPlot;
            public CMouse Mouse;
            public CTool(CFRAPlot _FRAPlot)
            {
                FRAPlot = _FRAPlot;
            ...
            /// <summary>
            /// Current 영역에 있는 FRA데이터를 Reference영역으로 이동시킵니다.
            /// </summary>
            ...
            public class CMouse
            {
                ...
                public CMouse(CFRAPlot FRAPlot)
                {
                ...
                /// <summary>
                /// 점선을 사용할 것인지 여부를 정합니다. true일시 켜지며
                /// 화면에 마우스를 올릴시 점선이 보입니다. 점선의 위치는 화면 위 데이터에 맞추어지며, 왼쪽위에 
                /// 작은 상자에 데이터의 값을 출력해줍니다.
                /// </summary>
                /// <param name="on"></param>
